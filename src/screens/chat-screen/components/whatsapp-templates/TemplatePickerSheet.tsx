...
/**
 * O seletor de template em si. Fica separado do WhatsAppTemplatesList porque a tela
 * de nova conversa precisa do mesmo seletor sem ter uma conversa ainda.
 */
export const TemplatePickerSheet = ({ sheetRef, inbox, onSend }: TemplatePickerSheetProps) => {
  ...
  const handleSend = (payload: TemplateSendPayload) => {
    onSend(payload);
    resetLocalState();
